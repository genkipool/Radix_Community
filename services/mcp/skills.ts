...
- *"Sign / actually send this transaction"* → \`setup_wallet_connector\` (install + pair once) → the local connector's \`send_transaction {manifest, network}\` → \`transaction_status\`.
