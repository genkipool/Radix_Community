...
vi.mock('lucide-react', () => {
    const icons = ['Menu', 'X', 'Sun', 'Moon', 'Globe', 'Server', 'Layers', 'BarChart2', 'BookOpen', 'GraduationCap', 'Gamepad2', 'Smartphone', 'FileText', 'MessageSquare', 'Eye', 'Check', 'Route', 'Sparkles', 'User', 'Terminal', 'CreditCard'];
    const mockIcon = () => null;
