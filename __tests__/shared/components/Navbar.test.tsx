...
vi.mock('lucide-react', () => {
    const icons = ['Menu', 'X', 'Sun', 'Moon', 'Globe', 'Server', 'Layers', 'BarChart2', 'BookOpen', 'GraduationCap', 'Gamepad2', 'Smartphone', 'FileText', 'MessageSquare', 'Eye', 'Check', 'Route', 'Sparkles', 'User', 'Terminal', 'CreditCard', 'Zap', 'Nfc', 'Library', 'Milestone', 'Map', 'Info', 'RefreshCcw', 'LogOut', 'Stamp'];
    const mockIcon = () => null;
