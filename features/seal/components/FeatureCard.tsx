...
interface FeatureCardProps {
  ...
  title: string;
  desc: string;
  /** Optional small pill rendered above the title (e.g., trust-model step tag). */
  tag?: string;
  delay?: number;
}
 ...
 * FeatureCard — RSC
 *
 * Standard card of the Radix Seal page: icon, optional tag pill, title and
 * description, following the card style of the home and Hyperscale sections.
 */
