/**
 * Hero — RSC (same layout strategy as the Hyperscale hero)
 *
 * Static two-column layout: institutional headline + CTAs on the left, the
 * Radix Seal insignia on the right, and a metrics bar underneath. Fully
...
export default function Hero({ t, locale }: SealLocaleSectionProps) {
