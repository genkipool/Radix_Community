 ...
 * CTAFinal — RSC
 *
 * Closing call to action, mirroring the home and Hyperscale CTAFinal format:
 * big gradient headline over a glow blob, two console actions.
 */
...
export default function CTAFinal({ t, locale }: SealLocaleSectionProps) {
  const cta = t.seal.cta;
