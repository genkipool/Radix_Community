            ...
            >
              ...
              <div className="flex items-start justify-between px-7 pt-6 pb-4 border-b border-[var(--color-card-border)]">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[var(--color-accent)]/20 to-[var(--color-secondary)]/20 border border-[var(--color-accent)]/30 flex items-center justify-center">
                ...
                <button
                  onClick={onClose}
                  className="w-8 h-8 flex items-center justify-center rounded-full text-[var(--color-text-muted)] hover:text-[var(--color-text-main)] hover:bg-[var(--color-bg)] transition-colors"
                ...
                {status === 'sent' ? (
                  ...
                  >
                    ...
                    <input
                      ...
                      className={`w-full rounded-xl bg-[var(--color-bg)] border ${
                        isEmailPadding ? 'border-red-500' : 'border-[var(--color-card-border)]'
