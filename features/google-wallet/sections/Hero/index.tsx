/**
 * Hero — RSC shell (same split strategy as the home and Hyperscale heroes)
 *
 *  ┌─ Hero (RSC) ─────────────────────────────────────────────────────────┐
 *  │  Static layout, gate validation panel, metrics bar                    │
...
import { INVISIBLE_FLOW_ID, BUSINESS_ID } from '../../data/links';
import type { GoogleWalletSectionProps } from '../../types';
import GoogleRadixIntegrationLogo from './components/GoogleRadixIntegrationLogo';

/** Terminal-style panel showing the zero-friction gate validation flow. */

export default function Hero({ t }: GoogleWalletSectionProps) {
  const hero = t.googleWallet.hero;
