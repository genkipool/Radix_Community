...
const DelegateButton = ({
    ...
    return (
        <button
            title={title}
            className={`rounded-xl font-black uppercase tracking-wider text-white whitespace-nowrap active:scale-95 hover:opacity-90 transition-[background,transform,opacity,box-shadow] duration-300 ${tiny ? 'px-3 py-1 text-[9px] rounded-lg' :
