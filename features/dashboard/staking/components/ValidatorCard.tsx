    ...
    return (
        <>
            <Card
                ...
                className={`p-0 overflow-hidden group cursor-pointer transition-all duration-300 hover:shadow-lg hover:border-[var(--color-primary)]/30 ${isExpanded && !isModalMode ? 'border-[var(--color-primary)]/40 shadow-lg' : ''
                    }`}
            >
