                ...
                <div className="relative flex items-center justify-between gap-4 px-5 sm:px-8 pt-6 pb-5 shrink-0">
                    <div className="flex items-center gap-5 min-w-0 flex-1">
                        ...
                        <div className="relative shrink-0 hidden sm:flex">
                            ...
                            <div className="relative z-10 w-16 h-16 rounded-2xl border-2 flex items-center justify-center bg-[var(--color-surface)] shadow-lg transition-transform hover:scale-105"
