...
const TransactionTabs = ({
    details, tx, t, onCopy, copiedAddress, onResourceClick, formatEntity, readingMode, network, columns,
    ...
    return (
        ...
        >
            ...
            <div className="p-4 sm:p-5 text-sm">
                ...
                {/* ══ DETAILS ══ */}
                {activeTab === 'details' && (
                    <TransactionDetailsTab details={details} tx={tx} tt={tt} te={t?.events ?? {} as Dictionary['events']} onCopy={onCopy} copiedAddress={copiedAddress} formatEntity={formatEntity} network={network} />
                )}
