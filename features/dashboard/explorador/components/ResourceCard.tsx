...
export function ResourceCard({
    ...
    const resourceType = (entityData?.details as Record<string, unknown>)?.resource_type as string || '-';
    const totalSupply = (entityData?.details as Record<string, unknown>)?.total_supply as string || '';
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-2">
                                    <span className="text-sm font-bold font-mono text-[var(--color-accent)] truncate">
                                        {name || (locale === 'es' ? 'Recurso' : 'Resource')}
                                    </span>
                                </div>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-2">
                                    <span className="text-sm font-bold text-blue-500 font-mono truncate">
                                        {resourceType === 'FungibleResourceManager' ? 'Fungible' : resourceType === 'NonFungibleResourceManager' ? 'Non-Fungible' : (locale === 'es' ? 'Recurso' : 'Resource')}
                                    </span>
                                </div>
                            </div>
                            <div>
                                ...
                                <div className="flex items-center gap-2">
                                    <span className="text-sm font-bold text-[var(--color-primary)] font-mono truncate">
                                        {totalSupply ? Number(totalSupply).toLocaleString(locale) : '-'}
                                    </span>
                                </div>
                            </div>
                            <div>
