...
function GridToggleIcon({ columns }: { columns: number }) {
    switch (columns) {
        case 1: return <Rows3 className="size-4" />;
        case 2: return <Grid2x2 className="size-4" />;
        case 3: return <Grid3x3 className="size-4" />;
        case 4: return <Grid4x3Icon className="size-4" />;
        default: return <Grid4x3Icon className="size-4" />;
    }
}
    ...
    return (
        <>
            ...
            >
                ...
                >
                    <GridToggleIcon columns={columns} />
                </button>
                <button
                    type="button"
                    onClick={increment}
            ...
            >
                <div className="pl-3 pr-1.5 py-2">
                    {isMobileGrid1 ? <Rows3 className="size-4" /> : <Grid2x2 className="size-4" />}
                </div>
